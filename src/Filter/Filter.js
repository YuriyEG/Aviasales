...
const Filter = ({filterHandler, filterMode }) => {
    ...
    return (
        <div className="filter" onClick={filterHandler}>
            ...
            <div className='filter__tab' style={lowClass} id='low'>САМЫЙ ДЕШЕВЫЙ</div>
            
            <div className='filter__tab' style={fstClass} id='fst'>САМЫЙ БЫСТРЫЙ</div>
            <div className='filter__tab' style={{ backgroundColor: 'rgba(33, 150, 243, 0.3)'}}>ОПТИМАЛЬНЫЙ</div>
